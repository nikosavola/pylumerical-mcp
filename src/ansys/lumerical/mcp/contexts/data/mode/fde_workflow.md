...
1. Add the geometry and materials.
1. Add a bare `FDE` object.
1. Configure the FDE object incrementally with `setnamed()`.
1. Save the setup file.
1. Stop and ask before solving; the solve/extract half lives in
   `mode_fde_results`.
